...
public class Utils {
    ...
    public static void replaceFragmentWithAnimation(int containerId,Fragment fragment, FragmentManager fm, String tag){
    ...
    public static void replaceFragmentWithAnimationVertical(int containerId,Fragment fragment, FragmentManager fm, String tag,boolean addToBackStack){
        FragmentTransaction transaction = fm.beginTransaction();
    ...
    public static void performWithBackStackTransaction(final FragmentManager fragmentManager, String tag, Fragment fragment, int content) {
