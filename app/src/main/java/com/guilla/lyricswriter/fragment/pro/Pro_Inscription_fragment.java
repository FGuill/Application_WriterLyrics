...
import com.guilla.lyricswriter.GooglePlaces.ParseAutoCompleteAdapter;
import com.guilla.lyricswriter.R;
import com.guilla.lyricswriter.SignupPro.SignUpProPresenter;
import com.guilla.lyricswriter.SignupPro.SignUpProPresenterImpl;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.done:{
                    ...
                    presenter.validateCredentials(getActivity(),type,fields,address);
            }
        }
    }
