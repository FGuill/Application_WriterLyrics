...
import com.guilla.lyricswriter.fragment.pagerTips.PagerFragment;
 ...
 */
public class client_Profil_container_fragment extends Fragment implements Updateable, PagerFragment.OnSelection,ProfilActivity.OnNotificationUpdateHistoric, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static client_Profil_container_fragment newInstance() {
        client_Profil_container_fragment myFragment = new client_Profil_container_fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getActivity() instanceof ProfilProActivity) {
            ...
            isClient=true;
            ((ProfilActivity) getActivity()).setHistoricListener(client_Profil_container_fragment.this);
