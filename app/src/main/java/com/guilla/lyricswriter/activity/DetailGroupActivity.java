...
import com.guilla.lyricswriter.fragment.pagerTipsCategory.PagerFragment;


/**
 * Created by Moi on 07/05/2016.
 */
public class DetailGroupActivity extends AppCompatActivity implements  View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hashtag);
          ...
          //      toolBar.setBackgroundColor(getResources().getColor(category_in_list.getColor()));
                ...
                Fragment currentFagment= getSupportFragmentManager().findFragmentById(R.id.container);
                if (currentFagment instanceof PagerFragment){
                }else {
                    FragmentManager fm = getSupportFragmentManager();
                    FragmentTransaction ft = fm.beginTransaction();
                    PagerFragment fragTwo =  PagerFragment.newInstance(group,barcolor);
                    ft.add(R.id.container, fragTwo);
                    ft.commit();
                }
            }
        }
